...
recommended_topics = {
    "Foundational Literacy": {
        "Letter Level": {
            "9months": {
                "July": {
                    "Week 1": ["Introduction to Alphabet (A–Z overview through songs & stories)"],
                ...
                "December": {
                    "Week 1": ["Speak Words with Clear Sounds (initial/final emphasis)"],
            ...
            "5months": {
                "July": {
                    "Week 1": ["Alphabet A–Z Introduction (song, story, visuals)", "Uppercase Recognition"],
        ...
        "Word Level": {
            "9months": {
                "July": {
                    "Week 1": ["Engage in simple conversations using common words and phrases"],
                    "Week 2": ["Use greetings and polite expressions in context"],
                    "Week 3": ["Practice common situational phrases (e.g., classroom, home)"],
                    "Week 4": ["Revision – Workbook speaking/listening drills + Split Test (e.g., listening MCQ + short oral test)"]
                },
                "August": {
                    ...
                    "Week 4": ["Revision – Workbook activities on noun usage + Split Test (e.g., identification + sentence formation)"]
                },
                "September": {
                    "Week 1": ["Identify personal pronouns (he, she, it, etc.)"],
                    "Week 2": ["Understand and use possessive pronouns (his, her, their)"],
                    "Week 3": ["Use pronouns to replace nouns in sentences"],
                    "Week 4": ["Revision – Pronoun-focused workbook + Split Test (fill-in-the-blanks + rewriting sentences)"]
                },
                "October": {
                    ...
                    "Week 4": ["Revision – Workbook exercises + Split Test (comparison chart + error correction)"]
                },
                "November": {
                    ...
                    "Week 4": ["Revision – Articles practice in workbook + Split Test (multiple-choice + usage)"]
                },
                "December": {
                    ...
                    "Week 4": ["Revision – Verb tense drills + Split Test (tense table + short passage correction)"]
                },
                "January": {
                    "Week 1": ["Identify common prepositions (in, on, at, by, etc.)"],
                    "Week 2": ["Understand how prepositions describe spatial relationships"],
                    "Week 3": ["Use prepositions to improve grammar proficiency"],
                    "Week 4": ["Revision – Preposition maze/workbook + Split Test (picture-based + blanks)"]
                },
                "February": {
                    "Week 1": ["Identify and use WH words (who, what, where, when, why, how)"],
                    "Week 2": ["Formulate WH questions orally and in writing"],
                    "Week 3": ["Practice asking and answering questions in sentences"],
                    "Week 4": ["Revision – Workbook Q&A + Split Test (question framing + response comprehension)"]
                },
                "March": {
                    ...
                    "Week 4": ["Final Test – Full workbook-based assessment + Split Final Test (oral + written)"]
                }
            },
            "5months": {
                "July": {
        ...
        "Sentence Level": {
            "9months": {
                ...
                "October": {
                    "Week 1": ["Recognize and use common contractions (e.g., can't, I'm)"],
        ...
        "Story Level": {
            "9months": {
                "July": {
                    ...
                    "Week 2": ["Recognize and interpret metaphors in conversations and texts"],
                    "Week 3": ["Incorporate idioms and metaphors into speaking and writing"],
                ...
                "October": {
                    "Week 1": ["Understand sentence types (exclamatory, declarative, etc.)"],
        ...
        "Advanced Level": {
            "9months": {
                "July": {
                    ...
                    "Week 3": ["Definition and examples of metaphors; differentiate between similes and metaphors"],
                    "Week 4": ["Revision + Split Test"]
                },
                "August": {
                ...
                "September": {
                    ...
                    "Week 3": ["Present Perfect Continuous + Writing prompts using present tense"],
                    "Week 4": ["Revision + Split Test"]
                },
                "October": {
                ...
                "March": {
                    "Week 1": ["Techniques for active listening (e.g., eye contact, nodding)"],
                    "Week 2": ["Summarising, paraphrasing, and asking clarifying questions"],
    ...
    "Foundational Numeracy": {
        "Beginner Level": {
            "Grade LKG to 1": {
                "9months": {
                    "July": {
                        "Week 1": ["Introduction to numbers 1-5 using fingers, charts, and real-life objects"],
                        "Week 2": ["Numbers 6-10; practice tracing and writing numbers"],
                        "Week 3": ["Matching numbers with quantities (e.g., 3 apples, 5 blocks)"],
                        "Week 4": ["Revision + Split Test (1-10 recognition & quantity)"]
                    },
                    "August": {
                        "Week 1": ["Counting daily objects (e.g., pencils, leaves, toys) up to 10"],
                        "Week 2": ["Counting using lines and finger patterns"],
                        "Week 3": ["Introduction to simple number songs and games for 1-10"],
                        "Week 4": ["Revision + Split Test (Counting + Number-object association)"]
                    },
                    "September": {
                    ...
                    "October": {
                        "Week 1": ["Introduction to Bundling (Bundle and stick method for 10s)"],
                        "Week 2": ["Place value understanding: 10 = 1 ten, 11 = 1 ten + 1 unit"],
                        "Week 3": ["Practice with number expansion (12 = 10 + 2, etc.)"],
                        "Week 4": ["Revision + Split Test (Place value till tens)"]
                    },
                    "November": {
                        "Week 1": ["Recognize and write numbers 21-30"],
                        "Week 2": ["Continue with 31-40"],
                        "Week 3": ["Complete 41-50 and practice counting forward/backward"],
                        "Week 4": ["Revision + Split Test (21-50 number identification + writing)"]
                    },
                    "December": {
                        "Week 1": ["Add numbers using fingers and objects (1-10)"],
                        "Week 2": ["Addition with number lines and visual aids"],
                        "Week 3": ["Add double-digit numbers without carryover (10-20 range)"],
                        "Week 4": ["Revision + Split Test (Addition)"]
                    },
                    "January": {
                        "Week 1": ["Subtraction using fingers, toys, and pictures (1-10)"],
                    ...
                    "February": {
                        "Week 1": ["Introduction to basic shapes: Circle, square, triangle"],
                        "Week 2": ["More shapes: Rectangle, oval; identify in environment"],
                        "Week 3": ["Compare shapes + Count and add shapes (e.g., 2 squares + 3 circles)"],
                        "Week 4": ["Revision + Split Test (Shapes + related operations)"]
                    },
                    "March": {
                        "Week 1": ["Recognize and write numbers 51-100"],
                        "Week 2": ["Place value till hundreds (e.g., 125 = 100 + 20 + 5)"],
                        "Week 3": ["Mixed practice: Add/Subtract + Shapes + Place Value"],
                        "Week 4": ["Final Revision + Split Test (All concepts)"]
                    }
                },
                "5months": {
                    "July": {
                        "Week 1": ["Numbers 1-10 (read, write, count with fingers & objects)"],
                    ...
                    "November": {
                        "Week 1": ["Basic shapes (circle, square, triangle, rectangle, oval)"],
            ...
            "Grade 2 and 3": {
                "9months": {
                    "July": {
                        ...
                        "Week 4": ["Revision + Split test (Writing & identifying numbers, odd/even)"]
                    },
                    "August": {
                    ...
                    "September": {
                        ...
                        "Week 4": ["Revision + Split test (Subtraction + word problems)"]
                    },
                    "October": {
                    ...
                    "December": {
                        ...
                        "Week 3": ["Multiplication games & visual activities (arrays, cootie catcher)"],
                        "Week 4": ["Revision + Split test (Multiplication)"]
                    },
                    "January": {
                        "Week 1": ["Basic 2D shapes: circle, triangle, square, rectangle"],
                    ...
                    "March": {
                        "Week 1": ["Math games: hopscotch, bingo, kaboom, place value war"],
                        "Week 2": ["Creative math activities: scavenger hunt, cootie catcher, puzzles"],
            ...
            "Grade 4": {
                "9months": {
                    "July": {
                        "Week 1": ["Read and write 2-digit numbers; identify ones and tens"],
                        "Week 2": ["Extend to 3-digit numbers; identify ones, tens, hundreds"],
                        "Week 3": ["Place value with blocks and expanded form (e.g., 456 = 400 + 50 + 6)"],
                        "Week 4": ["Revision + split test (number reading, writing, place value)"]
                    },
                    "August": {
                        "Week 1": ["Count objects in 2s, 5s, 10s using daily items"],
                        "Week 2": ["Place value puzzles (Which digit is in the 100s place?)"],
                        "Week 3": ["Introduce number comparison (>, <, =) based on place value"],
                        "Week 4": ["Revision + split test (counting, place value, comparisons)"]
                    },
                    "September": {
                        "Week 1": ["Add 2-digit numbers using fingers and lines"],
                        "Week 2": ["Add 3-digit numbers using blocks/visuals"],
                        "Week 3": ["Apply addition in shop/play scenarios (e.g., pretend money)"],
                        "Week 4": ["Revision + split test (addition with/without carry, real-life add)"]
                    },
                    "October": {
                        "Week 1": ["Subtract 2-digit numbers using counters/objects"],
                        "Week 2": ["Subtract 3-digit numbers using visual aids"],
                        "Week 3": ["Role-play: return/change money practice (shopkeeper game)"],
                        "Week 4": ["Revision + split test (subtraction with/without borrow, daily context)"]
                    },
                    "November": {
                        "Week 1": ["Practice estimation (about how many items? Round off)"],
                        "Week 2": ["Read numbers in words and write numerals (till 999)"],
                        "Week 3": ["Create daily math journal (write numbers seen in surroundings)"],
                        "Week 4": ["Revision + split test (reading, writing, estimating numbers)"]
                    },
                    "December": {
                    ...
                    "January": {
                        ...
                        "Week 2": ["Triangle, oval; Match real-world items with shapes"],
                        "Week 3": ["Draw and label shapes; shape hunt in surroundings"],
                        "Week 4": ["Revision + split test (shape recognition, matching, drawing)"]
                    },
                    "February": {
                        "Week 1": ["'Build it' with place value blocks (random numbers)"],
                        "Week 2": ["Number train activity (ones → tens → hundreds)"],
                        "Week 3": ["Number comparison + sequencing games (e.g., greater/lesser train)"],
                        "Week 4": ["Revision + split test (place value build, compare, sequence)"]
                    },
                    "March": {
                        "Week 1": ["Mixed review: addition, subtraction, number writing"],
                        "Week 2": ["Word problems + place value revision"],
                        "Week 3": ["Games-based recap: shop & learn, number train, build it"],
                        "Week 4": ["Final revision + split test (comprehensive: numbers, ops, shapes)"]
                    }
                },
                "5months": {
                    "July": {
                    ...
                    "August": {
                        ...
                        "Week 3": ["Subtract 2- & 3-digit numbers (with/without borrow)"],
                        "Week 4": ["Revision + Split Test"]
                    },
                    "September": {
            ...
            "Grade 4 and above": {
                "9months": {
                    "July": {
                        ...
                        "Week 4": ["Revision + Split Test (number sense & place value understanding)"]
                    },
                    "August": {
                        ...
                        "Week 4": ["Revision + Split Test (additions: vertical, horizontal, word problems)"]
                    },
                    "September": {
                        "Week 1": ["Subtract 2-digit - 2-digit numbers"],
                        "Week 2": ["Subtract 3-digit - 2/3-digit"],
                        "Week 3": ["Apply subtraction in daily life problems"],
                        "Week 4": ["Revision + Split Test (subtraction mastery & error-checking)"]
                    },
                    "October": {
                    ...
                    "November": {
                        ...
                        "Week 4": ["Revision + Split Test (tables + single-digit multiplication)"]
                    },
                    "December": {
                        ...
                        "Week 4": ["Revision + Split Test (practice and test application problems)"]
                    },
                    "January": {
                        "Week 1": ["What is Division? Concept of sharing, grouping"],
                        "Week 2": ["Division Facts - Relate with multiplication; 6 ÷ 2 = 3"],
                        "Week 3": ["Basic real-life division (candies, items)"],
                        "Week 4": ["Revision + Split Test (division problems + concepts)"]
                    },
                    "February": {
                        "Week 1": ["Introduction to Fractions - Understand 1/2, 1/4 as equal sharing"],
                        "Week 2": ["Relate fractions to division visually"],
                        "Week 3": ["Concept of 0 in operations"],
                        "Week 4": ["Revision + Split Test (fraction basics + understanding 0)"]
                    },
                    "March": {
                        "Week 1": ["Identify shapes, pattern rules (2,4,6...)"],
                        "Week 2": ["Compare lengths, weights, quantities"],
                        "Week 3": ["Number line, shopping, Roll & Race"],
                        "Week 4": ["Final Revision + Cumulative Split Test (full review + concept mapping)"]
                    }
                },
                "5months": {
                    "July": {
        ...
        "M Level 2": {
            "Grade 2 and 3": {
                "9months": {
                    "July": {
                        "Week 1": ["Revise writing/identifying 2-digit, 3-digit, and 4-digit numbers"],
                        "Week 2": ["Odd & even numbers; Identify even/odd in 3-digit numbers"],
                        "Week 3": ["Place value till thousands using number blocks & charts"],
                        "Week 4": ["Revision + Split Test (Number identification, Place Value, Odd/Even)"]
                    },
                    "August": {
                        "Week 1": ["Revision: Add/Subtract 2-digit & 3-digit numbers"],
                        "Week 2": ["Add/Subtract 4-digit numbers; focus on 0 in operations"],
                        "Week 3": ["Word problems – Addition/Subtraction (direct, simple problems)"],
                        "Week 4": ["Revision + Split Test (Add/Subtract concepts, word problems)"]
                    },
                    "September": {
                        "Week 1": ["Tables 2, 5, 10 (revision) + learning tables up to 6"],
                        "Week 2": ["Concept of multiplication, multiplication as repeated addition"],
                        "Week 3": ["Multiply: single × single, single × double, double × double"],
                        "Week 4": ["Revision + Split Test (Multiplication concepts + basic problems)"]
                    },
                    "October": {
                        "Week 1": ["Concept of division, division as equal sharing"],
                        "Week 2": ["Tables 7 to 12 + division using number lines"],
                        "Week 3": ["Division: single ÷ single, double ÷ single, triple ÷ single"],
                        "Week 4": ["Revision + Split Test (Division, Tables, Basic word problems)"]
                    },
                    "November": {
                        "Week 1": ["Identify operations from word problems (+, -, ×, ÷)"],
                        "Week 2": ["Solve 2-step problems with mixed operations"],
                        "Week 3": ["Vocabulary: sum, difference, product, quotient"],
                        "Week 4": ["Revision + Split Test (Mixed operations, Word problems)"]
                    },
                    "December": {
                        "Week 1": ["Identify shapes around us (2D & 3D)"],
                        "Week 2": ["Repeating patterns, skip counting patterns (2s, 5s, 10s)"],
                        "Week 3": ["Arithmetic patterns (like 2, 4, 6... and 5, 10, 15...)"],
                        "Week 4": ["Revision + Split Test (Shapes, Patterns)"]
                    },
                    "January": {
                        "Week 1": ["Compare objects: small vs big, short vs tall"],
                        "Week 2": ["Heavy vs light, more vs less, many vs few"],
                        "Week 3": ["Measuring with non-standard units (paperclips, blocks)"],
                    ...
                    "February": {
                        ...
                        "Week 4": ["Revision + Split Test (Time and application problems)"]
                    },
                    "March": {
            ...
            "Grade 4 and above": {
                "9months": {
                    "July": {
                        "Week 1": ["Introduction to 4- and 5-digit numbers, reading and writing"],
                        "Week 2": ["Place value up to ten thousand (expanded & standard form)"],
                        "Week 3": ["Number comparison, sequencing, identifying largest/smallest"],
                        "Week 4": ["Revision + Split Test (Place value, reading numbers)"]
                    },
                    "August": {
                        "Week 1": ["Add & subtract 3-digit numbers (no regrouping)"],
                        "Week 2": ["Add & subtract 4- and 5-digit numbers (with regrouping)"],
                        "Week 3": ["Word problems involving addition and subtraction"],
                        "Week 4": ["Revision + Split Test (operations and comprehension)"]
                    },
                    "September": {
                        ...
                        "Week 4": ["Revision + Split Test (tables, multiplication basics)"]
                    },
                    "October": {
                        "Week 1": ["Multiply 2-digit × 2-digit numbers (with and without carry)"],
                        "Week 2": ["Intro to division as sharing, using objects"],
                        "Week 3": ["Division with small numbers, vocabulary (quotient, remainder)"],
                        "Week 4": ["Revision + Split Test (multiplication and division)"]
                    },
                    "November": {
                        "Week 1": ["Understanding ½, ⅓, ¼ using visuals (pizza, money)"],
                        "Week 2": ["Functional role of zero in operations (e.g., 304 vs 340)"],
                        "Week 3": ["Word problems involving fractions and zero"],
                        "Week 4": ["Revision + Split Test (fractions, zero usage)"]
                    },
                    "December": {
                        "Week 1": ["Understand keywords: sum, difference, product, quotient"],
                        "Week 2": ["Mixed operation problems from real-life scenarios"],
                        "Week 3": ["Focus on logic-based problems and reasoning"],
                        "Week 4": ["Revision + Split Test (applied arithmetic, problem solving)"]
                    },
                    "January": {
                        "Week 1": ["Identify 2D shapes around us (circle, square, triangle)"],
                        "Week 2": ["Introduction to 3D solid shapes (cube, sphere, cylinder)"],
                        "Week 3": ["Matching shapes with real objects"],
                        "Week 4": ["Revision + Split Test (shapes and geometry vocabulary)"]
                    },
                    "February": {
                    ...
                    "March": {
                        "Week 1": ["Comparing lengths, weights, sizes (more/less, longer/shorter)"],
                        "Week 2": ["Daily time reading (hour, half-hour); daily routine activities"],
                        "Week 3": ["Vocabulary: heavy/light, long/short, tall/short, many/few"],
                        "Week 4": ["Revision + Final Assessment"]
                    }
                },
                "5months": {
...
def get_recommended_topics(program: str, level: str, duration: str, month: str, week: str, grade: str = None) -> List[str]:
    """
